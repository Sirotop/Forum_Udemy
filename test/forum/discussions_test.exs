defmodule Forum.DiscussionsTest do
  use Forum.DataCase

  alias Forum.Discussions

  describe "topics" do
    alias Forum.Discussions.Topic

    import Forum.DiscussionsFixtures
  ...
  describe "comments" do
    alias Forum.Discussions.Comment

    import Forum.DiscussionsFixtures

    @invalid_attrs %{conent: nil}
    ...
    test "update_comment/2 with valid data updates the comment" do
      comment = comment_fixture()
      update_attrs = %{conent: "some updated conent"}

      assert {:ok, %Comment{} = comment} = Discussions.update_comment(comment, update_attrs)
      assert comment.conent == "some updated conent"
    end
